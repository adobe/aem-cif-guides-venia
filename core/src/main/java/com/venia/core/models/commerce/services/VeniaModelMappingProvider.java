...
@Designate(ocd = VeniaModelMappingProvider.Configuration.class)
public class VeniaModelMappingProvider implements ModelMappingProvider {
    private static final Logger LOGGER = LoggerFactory.getLogger(VeniaModelMappingProvider.class);
    ...
    @ObjectClassDefinition(name = "Venia Components Model Mapping Provider")
