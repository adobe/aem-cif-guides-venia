...
@Component(
    ...
    property = {
        ...
        Constants.SERVICE_RANKING + ":Integer=-8000"
    })
        ...
        if (currentPage != null) {
            ...
            if (siteStructure.isProductPage(currentPage)) {
                ...
                if (productList != null) {
                    ...
                    if ((categoryRetriever == null || categoryRetriever.fetchCategory() == null && categoryRetriever.hasErrors() ||
                            productList.getSearchResultsSet().hasErrors())) {
                        slingResponse.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Internal server error");
                        return;
                    }
                }
            }
